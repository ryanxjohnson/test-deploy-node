...
function autocomplete(input, latInput, lngInput) {
    ...
    // if someone hits enter prevent form submission
...
// could default to user's location by navigator.geolocation.getCurrentPosition
// see JavaScript30 course
...
function typeAhead(search) {
    ...
    searchInput.on('input', function () {
        ...
        axios.get('/api/search?q=' + this.value).then(function (res) {
            ...
            searchResults.innerHTML = dompurify.sanitize('<div class="search__result">Not results for ' + _this.value + ' found!</div>');
        }).catch(function (err) {
            console.error(err); // or send to sentry
        });
    });
